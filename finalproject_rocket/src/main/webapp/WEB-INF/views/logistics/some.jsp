                                ...
                                <div class="table-responsive">
                                    <table id="example6" class="display table table-bordered table-separated"
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" id="row-2-position" name="row-2-position"
                                                       value="Accountant"></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" id="row-5-position" name="row-5-position"
                                                       value="Accountant"></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" id="row-8-position" name="row-8-position"
                                                       value="Integration Specialist"></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" id="row-9-position" name="row-9-position"
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" id="row-10-position" name="row-10-position"
                                                       value="Software Engineer"></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" id="row-11-position" name="row-11-position"
                                                       value="Office Manager"></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" id="row-12-position" name="row-12-position"
                                                       value="Support Lead"></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" id="row-13-position" name="row-13-position"
                                                       value="Regional Director"></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" id="row-14-position" name="row-14-position"
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" id="row-15-position" name="row-15-position"
                                                       value="Regional Director"></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" id="row-16-position" name="row-16-position"
                                                       value="Marketing Designer"></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" id="row-17-position" name="row-17-position"
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" id="row-18-position" name="row-18-position"
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" id="row-19-position" name="row-19-position"
                                                       value="Software Engineer"></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" id="row-20-position" name="row-20-position"
                                                       value="Personnel Lead"></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" id="row-21-position" name="row-21-position"
                                                       value="Development Lead"></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" id="row-22-position" name="row-22-position"
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" id="row-23-position" name="row-23-position"
                                                       value="Pre-Sales Support"></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" id="row-24-position" name="row-24-position"
                                                       value="Sales Assistant"></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" id="row-25-position" name="row-25-position"
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" id="row-26-position" name="row-26-position"
                                                       value="Developer"></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" id="row-27-position" name="row-27-position"
                                                       value="Regional Director"></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" id="row-28-position" name="row-28-position"
                                                       value="Software Engineer"></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" id="row-29-position" name="row-29-position"
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" id="row-30-position" name="row-30-position"
                                                       value="Regional Marketing"></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" id="row-31-position" name="row-31-position"
                                                       value="Integration Specialist"></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" id="row-32-position" name="row-32-position"
                                                       value="Developer"></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" id="row-33-position" name="row-33-position"
                                                       value="Technical Author"></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" id="row-34-position" name="row-34-position"
                                                       value="Team Leader"></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" id="row-35-position" name="row-35-position"
                                                       value="Post-Sales support"></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" id="row-36-position" name="row-36-position"
                                                       value="Marketing Designer"></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" id="row-37-position" name="row-37-position"
                                                       value="Office Manager"></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" id="row-38-position" name="row-38-position"
                                                       value="Secretary"></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" id="row-39-position" name="row-39-position"
                                                       value="Financial Controller"></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" id="row-40-position" name="row-40-position"
                                                       value="Office Manager"></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" id="row-41-position" name="row-41-position"
                                                       value="Director"></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" id="row-42-position" name="row-42-position"
                                                       value="Support Engineer"></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" id="row-43-position" name="row-43-position"
                                                       value="Software Engineer"></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" id="row-44-position" name="row-44-position"
                                                       value="Support Engineer"></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" id="row-45-position" name="row-45-position"
                                                       value="Developer"></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" id="row-46-position" name="row-46-position"
                                                       value="Support Engineer"></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" id="row-47-position" name="row-47-position"
                                                       value="Data Coordinator"></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" id="row-48-position" name="row-48-position"
                                                       value="Software Engineer"></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" id="row-49-position" name="row-49-position"
                                                       value="Software Engineer"></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" id="row-50-position" name="row-50-position"
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" id="row-51-position" name="row-51-position"
                                                       value="Sales Assistant"></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" id="row-52-position" name="row-52-position"
                                                       value="Regional Director"></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" id="row-53-position" name="row-53-position"
                                                       value="Systems Administrator"></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" id="row-54-position" name="row-54-position"
                                                       value="Developer"></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" id="row-55-position" name="row-55-position"
                                                       value="Regional Director"></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" id="row-56-position" name="row-56-position"
                                                       value="Javascript Developer"></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" id="row-57-position" name="row-57-position"
                                                       value="Customer Support"></td>
