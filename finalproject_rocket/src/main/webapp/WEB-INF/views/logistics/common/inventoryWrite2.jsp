                            ...
                            <div class="box">
                                ...
                                <div class="box-body p-12"> <%--action="${path }/logistics/write"--%>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-2 col-5" style="margin:5px; margin-top:13px;">
                        ...
                        <script>
                            ...
                            function insertInventory() {
                                    ...
                                    table.rows().every(function (index) {
                                        ...
                                        for (var i = 0; i < columnNames.length; i++) {
                                            ...
                                            if (i === 1) {
                                                ...
                                                if (rowData["prdIvQuantity"].includes("최소 1 입력")) {
                                                    alert("도서/수량을 입력 해주세요");
                                                    return;
                                                } else if (isNaN(rowData["prdIvQuantity"])) {
                                ...
                                for (var i = 0; i < prdInventory.length; i++) {
                                    ...
                                    if (prdInventory[i]["prdIvQuantity"].includes("최소 1 입력")) {
                                        // alert("도서/수량을 입력 해주세요");
                                        alert("3");
                                        return;
                                    } else if (isNaN(prdInventory[i]["prdIvQuantity"])) {
                                        // alert("도서의 수량은 숫자만 입력 가능합니다.");
                                        alert("4");
                                        return;
                                    }
