                            ...
                            <div class="box">
                                ...
                                <div class="box-body p-12"> <%--action="${path }/logistics/write"--%>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-2 col-5" style="margin:0px; margin-top:0px" ;><label
                                                class=" form-label">
                                            <i class="si-organization si" style="margin-right:10px;" for="pubName"></i>출판사</label>
                                            <%--               <select
                                                                   class="form-control select2" name="recieveBrcId" multiple="multiple"
                                                                   data-placeholder="Select a State" style="width: 100%;">--%>
                                            <select
                                                    class=" form-control select2" name="pubName" id="pubName"
                                    ...
                                    <div class="row" style="margin-top:10px;">
                                        ...
                                        <div class="col-lg-2 col-5">
                                            <label class="form-label" style="margin:5px;"
                                                ...
                                                출판일</label>
                                            <input class="form-control" id="publisherDate" name="publisherDate"
                                                   type="date"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-2 col-5 form-group">
                                            <label class="form-label" style="margin:5px;" for="prdInStk">
                                                <i class="si-calendar si" style="margin-right:10px;"></i>
                                                입고 단가</label>
                                            <div class="input-group"><span class="input-group-addon">&#8361;</span>
                                                <input type="number" id="prdInStk" name="prdInStk" class="form-control"
                                                       placeholder="입고 단가"
                                                       required
                                                       data-validation-containsnumber-regex="(\d)+"
                                                       data-validation-containsnumber-message="숫자만 입력 가능합니다.">
                                        ...
                                        <div class="col-lg-2 col-5 form-group">
                                            <label class="form-label" style="margin:5px;" for="prdOutStk">
                                                <i class="si-calendar si" style="margin-right:10px;"></i>
                                                출고 단가</label>
                                            <div class="input-group"><span class="input-group-addon">&#8361;</span>
                                                <input type="number" id="prdOutStk" name="prdOutStk"
                                ...
                                <table id="example1"
                                    ...
                                    <c:forEach var="prd" items="${uniqueProductList }">
                                        <tr class="bt-5 border-primary">
                                            ...
                                            <td data-column-name="PRD_FILE_NAME_ORI"
                                                data-parent-column="PRD_FILE_NAME_ORI"
                                                data-table-name="PRD_ATTACH">표지
                                            </td>
