   ...
   // ==================================================================
     ...
     @RequestMapping("/insertaprv")
       public String insertAprvView(@RequestParam(value = "startDate", required = false) String startDate, 
           ...
           ArrayList<Map<String, Object>> inventoryInfo = (ArrayList<Map<String, Object>>)session.getAttribute("inventoryInfo");
         
           /*  세션 내용 복사  */
          ArrayList<Map<String, Object>> inventoryInfoCopy = new ArrayList<>();
           if (inventoryInfo != null) {
              for (Map<String, Object> item : inventoryInfo) {
                 inventoryInfoCopy.add(new HashMap<>(item));
              }
           }
           
           /*   모델 적용   */
          m.addAttribute("inventoryInfo", inventoryInfoCopy);
